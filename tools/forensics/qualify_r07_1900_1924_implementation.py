...
EXPECTED_BLOB='70a18a3b69e8ea46bd5132673fe9fcf8a36595ee'; EXPECTED_RULES=1956; FIRST=1900; LAST=1924
...
def main():
    ...
    print('STATIC_R07_1900_1924_QUALIFICATION=PASS')
